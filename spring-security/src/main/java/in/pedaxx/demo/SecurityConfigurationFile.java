...
public class SecurityConfigurationFile extends WebSecurityConfigurerAdapter {
	...
	protected void configure(HttpSecurity http) throws Exception {
		http.authorizeRequests().antMatchers("/admin/**").hasRole("ADMIN").antMatchers("/user/**")
				.hasAnyRole("USER", "ADMIN").antMatchers("/index").permitAll().and() // Possibly more configuration ...

				.formLogin(); // enable form based log in // set permitAll for all URLs associated with Form
								// Login
